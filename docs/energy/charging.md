...
Die Akkus können problemlos mit 1C, also mit einer Stromstärke nahe ihrer Kapazität innerhalb von ca. 1 Stunde geladen werden. Wenn im Außendienst nötig auch 2C. Falls mehr Zeit vorhanden ist, sollte aber z.B. gegen 0.5C reduziert werden.  
Ein hoher Ladestand (SoC - State of Charge) sollte nicht über einen langen Zeitraum bestehen - hier werden die Zellen geschädigt (SoH - State of Health).